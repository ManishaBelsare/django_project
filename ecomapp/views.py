from django.shortcuts import render,redirect,HttpResponce
from django.contrib.auth import authenticate, login, logout
from .models import Orderhistory, Product, Cart, Order, Contactenquiry
...
def addtocart(request, pid):
    if request.user.is_authenticated:
        ...
        if n == 1:
            ...
            return render(request, 'product_detail.html', context)
            #return HttpResponce("Product added in cart")
    else:
        return redirect('/login')
...
def makepayment(request):
    ...
    data = {"amount": sum * 100, "currency": "INR", "receipt": "old"}
